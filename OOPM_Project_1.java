...
{
	/*OOPM_Project_1 o;
	public MyWindowAdapter(OOPM_Project_1 o)
	{
		this.o=o;
	}
...
class OOPM_Project_1 extends JFrame implements ActionListener,AdjustmentListener
{
    ...
    OOPM_Project_1()
    {
        ...
        //Adding Window Listener for Window Closing
	...
	//Closing on Pressing Close Button
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(s.equals("Print"))
        {
            try
            {
                t.print();   //was throwing Excetion so put it in try catch block
            }
            catch(Exception e) {}
        }
